		...
		<div>
			<main>
				<section className="container">
					<div className="svg-wrapper">
						...
						>
							<g>
								<path
									xmlns="http://www.w3.org/2000/svg"
									d="m300.1 156.473a40.729 40.729 0 1 0 -40.726 40.627 40.723 40.723 0 0 0 40.726-40.627zm-40.726 28.627a28.626 28.626 0 1 1 28.726-28.627 28.71 28.71 0 0 1 -28.726 28.627z"
									fill="#ffffff"
								...
								<path
									xmlns="http://www.w3.org/2000/svg"
									d="m126.963 257.1a28.122 28.122 0 1 0 28.188 28.121 28.186 28.186 0 0 0 -28.188-28.121zm0 44.243a16.122 16.122 0 1 1 16.188-16.122 16.174 16.174 0 0 1 -16.188 16.126z"
									fill="#ffffff"
									data-original="#000000"
								...
								<path
									xmlns="http://www.w3.org/2000/svg"
									d="m305.041 309.382a24.1 24.1 0 1 0 24.154 24.1 24.154 24.154 0 0 0 -24.154-24.1zm0 36.2a12.1 12.1 0 1 1 12.154-12.1 12.141 12.141 0 0 1 -12.154 12.099z"
									fill="#ffffff"
									data-original="#000000"
								...
								<path
									xmlns="http://www.w3.org/2000/svg"
									d="m433.349 227.315a24.1 24.1 0 1 0 -24.154-24.1 24.154 24.154 0 0 0 24.154 24.1zm0-36.2a12.1 12.1 0 1 1 -12.154 12.1 12.141 12.141 0 0 1 12.154-12.1z"
									fill="#ffffff"
									data-original="#000000"
					...
					<div>
						<Link to="/map">
							<button>ورود به صفحه آدرس یابی</button>
						</Link>
						<Link to="/search">
							<button>ورود به صفحه جستجو</button>
						</Link>
					</div>
				</section>
			</main>
